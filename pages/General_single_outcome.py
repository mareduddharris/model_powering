...
st.title("Understanding the impact of modeling")
...
c.write('Now consider what the model performance will be able to achieve in terms of True Positive Rate and True Negative Rate')
...
c.write("Using the True Positive and True Negative rata we can calculate the False Positive Rate and False Negative Rate - and develop a ROC curve")
